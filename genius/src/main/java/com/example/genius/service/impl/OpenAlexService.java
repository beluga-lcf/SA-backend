...
public class OpenAlexService {
    ...
    public ScholarInform getAuthorSingle(String authorId) {
        ...
        JSONArray namesJson = anAuthor.getJSONArray("display_name_alternatives");
        names = new String[namesJson.length()];
...
//        JSONArray jsonArray = new JSONArray();
        ...
        for (int i = 0; i < resArray.size(); i++) {
            ...
            com.alibaba.fastjson2.JSONArray j2 = j.getJSONArray("concepts");
