...
ALTER TABLE authors
    ADD PRIMARY KEY (id);
ALTER TABLE authors_counts_by_year
    ADD PRIMARY KEY (author_id, year);
ALTER TABLE authors_ids
    ADD PRIMARY KEY (author_id);
ALTER TABLE concepts
    ADD PRIMARY KEY (id);
ALTER TABLE concepts_ancestors
    ADD PRIMARY KEY (concept_id, ancestor_id);
ALTER TABLE concepts_counts_by_year
    ADD PRIMARY KEY (concept_id, year);
ALTER TABLE concepts_ids
    ADD PRIMARY KEY (concept_id);
ALTER TABLE institutions
    ADD PRIMARY KEY (id);
ALTER TABLE institutions_associated_institutions
    ADD PRIMARY KEY (institution_id, associated_institution_id);
ALTER TABLE institutions_counts_by_year
    ADD PRIMARY KEY (institution_id, year);
ALTER TABLE institutions_geo
    ADD PRIMARY KEY (institution_id);
ALTER TABLE institutions_ids
    ADD PRIMARY KEY (institution_id);
ALTER TABLE publishers
    ADD PRIMARY KEY (id);
ALTER TABLE publishers_counts_by_year
    ADD PRIMARY KEY (publisher_id, year);
ALTER TABLE publishers_ids
    ADD PRIMARY KEY (publisher_id);
ALTER TABLE sources
    ADD PRIMARY KEY (id);
ALTER TABLE sources_counts_by_year
    ADD PRIMARY KEY (source_id, year);
ALTER TABLE sources_ids
    ADD PRIMARY KEY (source_id);
ALTER TABLE works
    ADD PRIMARY KEY (id);
ALTER TABLE works_primary_locations
    ADD PRIMARY KEY (work_id, source_id);
ALTER TABLE works_locations
    ADD PRIMARY KEY (work_id, source_id);
ALTER TABLE works_best_oa_locations
    ADD PRIMARY KEY (work_id, source_id);
ALTER TABLE works_authorships
    ADD PRIMARY KEY (work_id, author_id);
ALTER TABLE works_biblio
    ADD PRIMARY KEY (work_id);
ALTER TABLE works_concepts
    ADD PRIMARY KEY (work_id, concept_id);
ALTER TABLE works_ids
    ADD PRIMARY KEY (work_id);
ALTER TABLE works_mesh
    ADD PRIMARY KEY (work_id);
ALTER TABLE works_open_access
    ADD PRIMARY KEY (work_id);
ALTER TABLE works_referenced_works
    ADD PRIMARY KEY (work_id);
ALTER TABLE works_related_works
    ADD PRIMARY KEY (work_id);
